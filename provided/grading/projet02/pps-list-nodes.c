...
int main(int argc, char* argv[])
{
    ...
    for(size_t i = 0; i < client.args->N; i++) {
        ...
        /* CORRECTEUR: NULL would've worked as well... (also, having a malloc
         * without a corresponding free is a bit weird...) [-0 style]
         */
...
/* CORRECTEUR: Some inconsistent spacing (excessive empty lines, post-comma
 * spaces...) [-0.25 style]
 */
