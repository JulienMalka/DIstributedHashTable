...
int main(int argc, char* argv[])
{
    ...
    /* CORRECTEUR: pps_value_t is a constant string [-0.5 compilation] */
    ...
    for (size_t i = 1; i < nbr_arg; i++) {
        ...
        /* CORRECTEUR:
         * First iteration: concat is just a pps_value_t. This will blow up.
         * Second iteration: ...
         * (Hint: strcat does not reallocate the buffer)
         * [-0.5 execution]
         */
    }
