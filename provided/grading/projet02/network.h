...
/* CORRECTEUR: This file must not be modified, and compilation fails if this
 * file is reset to its original state. Consider moving these functions into a
 * separate (header) file (e.g. network-utils.h or whatever).
 * [-1 malus]
 */
